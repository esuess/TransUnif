...
par(mfrow=c(2,1))
mx=max(x, q); xx = seq(0, mx, length=1000)
hist(x, prob=T, ylim=c(0,.7), xlim=c(0, mx),
col="wheat", main="CHISQ(1)")
lines(xx, dchisq(xx, 1), col="blue", lwd=2)
hist(q, prob=T, ylim=c(0,.7), xlim=c(0, mx),
col="wheat", main="CHISQ(2)")
lines(xx, dexp(xx, 1/2), col="red")
lines(xx, dchisq(xx, 2), col="blue", lwd=2,
lty="dashed")
par(mfrow=c(1,1))
